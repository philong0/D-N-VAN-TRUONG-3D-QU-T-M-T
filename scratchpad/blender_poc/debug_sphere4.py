...
# try EXR output (linear float, bypasses display transform on save)
scene.render.image_settings.file_format = 'OPEN_EXR'
scene.render.image_settings.color_depth = '32'
scene.render.filepath = "/home/ubuntu/dr-vantruong-3d-studio/scratchpad/blender_poc/debug_sphere4.exr"
